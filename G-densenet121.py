...
history = LossHistory()
checkpoint = ModelCheckpoint( r"/data/tongshun/new/result/yanshimingcheng/G-densenet121_1.00.8yanshimingcheng_weights.h5",
                                 monitor="val_acc",
                                 mode='max',
...
history.loss_plot('epoch',r"/data/tongshun/new/result/yanshimingcheng/G-densenet121_1.00.8yanshimingcheng.png",
                          r"/data/tongshun/new/result/yanshimingcheng/G-densenet121_1.00.8yanshimingcheng.txt")
labels=[
'其他','岩屑砂岩','花岗岩','粉砂岩',
'石英砂岩', '凝灰岩', '板岩','玄武岩','闪长岩']
model.load_weights(r"/data/tongshun/new/result/yanshimingcheng/G-densenet121_1.00.8yanshimingcheng_weights.h5")
y_true,y_pred=[],[]
...
print(y_true)
print(y_pred)
plot_confusion_matrix(y_true,y_pred,labels,save_path=r"/data/tongshun/new/result/yanshimingcheng/G-densenet121_1.00.8yanshimingcheng-confusion_matrix.png")