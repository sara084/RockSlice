...
class BilinearInterpolation(Layer):
    ...
    def call(self, tensors, mask=None):
        ...
        # transformation = transformation * tf.convert_to_tensor([1, 0, 0, 0, 1, 0], tf.float32)
    ...
    def _make_regular_grids(self, batch_size, height, width, channels=None):
    ...
    def _transform(self, X, affine_transformation, output_size):
        ...
        num_channels = K.shape(X)[3] if len(output_size) < 3 else output_size[2]
