...
history = LossHistory()
checkpoint = ModelCheckpoint(r"E:\TS\bishe\new\result\yanshimingcheng\vgg16yanshimingcheng.h5",
                                 monitor="val_acc",
                                 mode='max',
...
history.loss_plot('epoch',r'E:\TS\bishe\new\result\yanshimingcheng\VGG_yanshimingcheng.png',
                  r'E:\TS\bishe\new\result\yanshimingcheng\VGG_yanshimingcheng.txt')
labels=[
'其他','岩屑砂岩','花岗岩','粉砂岩',
'石英砂岩', '凝灰岩', '板岩','玄武岩','闪长岩']
...
print(y_true)
print(y_pred)
plot_confusion_matrix(y_true,y_pred,labels,save_path=r'E:\TS\bishe\new\result\yanshimingcheng\VGG_yanshimingcheng-confusion_matrix.png')